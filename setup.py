...
setup(name='maskgen',
      ...
      install_requires=['networkx>=1.11','pillow>=3.4.2','scikit-image','tkintertable','bitstring', 'awscli>=1.10.66', 'boto3>=1.3.1','numpy>=1.13.1','moviepy', 'h5py>=2.6.0','pydot>=1.2.3','graphviz>=0.5.1','pygraphviz>=1.3.1','rawpy>=0.10.1','cachetools','requests','matplotlib','pandas','wave'],
      entry_points=
       {'gui_scripts': [
